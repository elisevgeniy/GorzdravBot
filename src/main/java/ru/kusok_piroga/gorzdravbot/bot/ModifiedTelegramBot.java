package ru.kusok_piroga.gorzdravbot.bot;
...
import io.github.drednote.telegram.core.UpdateRequestContext;
...
public class ModifiedTelegramBot implements TelegramBot {
    private static final Logger log = LoggerFactory.getLogger(ModifiedTelegramBot.class);
    /**
     * The name of the bot
     */
     ...
     */
    public ModifiedTelegramBot(TelegramProperties properties, Collection<UpdateHandler> updateHandlers, ObjectMapper objectMapper, ExceptionHandler exceptionHandler, UpdateFilterProvider updateFilterProvider, TelegramMessageSource messageSource, TelegramClient telegramClient) {
